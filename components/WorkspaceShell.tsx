        ...
        <header className="sticky top-0 z-30 border-b border-[#e5e5e5] bg-[#fbfbfb]/95 backdrop-blur-xl">
          <div className="flex min-h-[56px] items-center gap-3 px-4 sm:px-6 lg:px-7">
            ...
            <div className="hidden items-center gap-2 sm:flex">
              ...
              {canOpen('/buyers') && <Link href="/buyers" prefetch={false} className="rounded-md border border-[#e1e1e1] bg-white px-2.5 py-1.5 text-xs font-medium text-[#525252] transition hover:bg-[#fafafa]">Buyers</Link>}
