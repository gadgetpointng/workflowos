...
const navGroups:Group[]=[
 ...
 {label:'Buyers & Sales',items:[['Buyer Acquisition','/acquisition','↗'],['Buyer Intelligence','/buyers','⌕'],['Buyer Radar','/buyers/radar','◉'],['Leads','/leads','◎'],['Customers','/customers','◉'],['Quotes','/quotes','▱'],['Sales','/sales','₦'],['Opportunities','/opportunities','✦'],['Revenue Rescue','/revenue-rescue','₦'],['Campaigns','/campaigns','☆'],['Social','/social','◎'],['Goals','/goals','◎']].map(([label,href,icon])=>({label,href,icon}))},
 ...
 {label:'Team & Administration',items:[['Owner Control','/owner','◆'],['Owner Communications','/owner-communications','✦'],['Team','/team','♙'],['Team Pulse','/team/pulse','♙'],['Branch Radar','/branch-radar','⌁'],['Activity','/activity','◌'],['Integrations','/integrations','↗'],['Facebook Leads','/integrations/facebook-leads','f'],['Integration Commands','/integration-commands','⇢'],['Settings','/settings','⚙'],['Launch Readiness','/launch-readiness','✓']].map(([label,href,icon])=>({label,href,icon}))}
];
