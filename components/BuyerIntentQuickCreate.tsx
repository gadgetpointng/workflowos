      ...
      <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-emerald-200 bg-emerald-50/70 p-4">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            <span className="rounded-full bg-emerald-600 px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.12em] text-white">Live</span>
            <span className="text-sm font-black text-emerald-950">Public buyer intake is active</span>
          </div>
          <p className="mt-1 max-w-2xl text-xs font-medium leading-5 text-emerald-900/75">
            Real customer requests submitted through the public GadgetPoint request page enter Buyer Intelligence automatically and are matched against the live catalog.
          </p>
        </div>
        <a
          href="/request"
          target="_blank"
          rel="noreferrer"
          className="ios-action inline-flex min-h-[42px] items-center justify-center rounded-[13px] bg-emerald-700 px-4 text-sm font-bold text-white shadow-sm transition active:scale-[.97]"
        >
          Open live buyer request
        </a>
      </div>
