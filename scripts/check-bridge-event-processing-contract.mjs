...
requireText('generic buyer workflow write observability', genericBridge, [
  ...
  "operation: 'leads.insert.whatsapp'",
  "operation: 'leads.insert.acquisition'",
  ...
  "code: taskError.code",
  "code: whatsappLeadInsertError.code",
  "code: acquisitionLeadInsertError.code",
...
for (const errorName of [
  ...
  'taskError',
  'whatsappLeadInsertError',
  'acquisitionLeadInsertError',
  'leadRefreshError',
  'leadAssignmentError',
